...
Le plugin permet l'import de données **MAJIC de 2012 à 2019 et des données EDIGEO** . Il est possible d'importer des données de manière incrémentale, **étape par étape**, ou bien d'importer **en une seule fois**.
...
* Choisir la **version du format** en utilisant les flèches haut et bas
    ...
    - Seuls les formats de 2012 à 2019 sont pris en compte

* Choisir le **millésime des données**, par exemple 2019
