...
<qgis version="2.0.0-Dufour" minimumScale="-4.65661e-10" maximumScale="3000" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_label20130224132539746',[% $id %])" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
