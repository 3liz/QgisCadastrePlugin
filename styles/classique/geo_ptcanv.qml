...
<qgis version="2.0.0-Dufour" minimumScale="-4.65661e-10" maximumScale="1800" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="geo_sym" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="01" label="Point géodésique borné"/>
      <category symbol="1" value="02" label="Point géodésique non borné"/>
      <category symbol="2" value="03" label="Point de canevas d'ensemble borné"/>
      <category symbol="3" value="04" label="Point de canevas d'ensemble non borné"/>
      <category symbol="4" value="05" label="Point de polygonation borné"/>
      <category symbol="5" value="06" label="Point de polygonation non borné"/>
      <category symbol="6" value="07" label="Repère NGF"/>
      <category symbol="7" value="08" label="Borne NGF"/>
      <category symbol="8" value="09" label="Nivellement MRL"/>
      <category symbol="9" value="10" label="Autre repère de nivellement"/>
      <category symbol="10" value="11" label="Borne limite de commune"/>
      <category symbol="11" value="71" label="Point géodésique borné"/>
      <category symbol="12" value="72" label="Point géodésique non borné"/>
      <category symbol="13" value="73" label="Point borné de canevas cadastral&#xa;ordinaire ou préalable à AFAF ou&#xa;d'appui d'une prise de vues&#xa;permettant la confection d'un plan&#xa;de classe de précision [20 cm]"/>
      <category symbol="14" value="74" label="Point borné de canevas pérenne ou&#xa;cadastral de précision"/>
      <category symbol="15" value="75" label="Point borné de canevas d'appui&#xa;d'une prise de vues permettant la&#xa;confection d'un plan de classe de&#xa;précision [10 cm]"/>
      <category symbol="16" value="76" label="Point borné d'appui de&#xa;géoréférencement"/>
      <category symbol="17" value="77" label="Repère NGF"/>
      <category symbol="18" value="78" label="Borne du NGF"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="geo_can"/>
    <edittype labelontop="0" editable="1" type="0" name="geo_map"/>
    <edittype labelontop="0" editable="1" type="0" name="geo_palt"/>
    <edittype labelontop="0" editable="1" type="0" name="geo_ppln"/>
    <edittype labelontop="0" editable="1" type="0" name="geo_ptcanv"/>
    <edittype labelontop="0" editable="1" type="0" name="geo_sym"/>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_ptcanv20130224142527348',[% $id %])" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
