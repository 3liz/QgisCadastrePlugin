...
<qgis version="2.0.0-Dufour" minimumScale="0" maximumScale="1800" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/namedStyle" value="Light"/>
  ...
  <labelattributes>
    <label fieldname="ogr_atr_val" text=""/>
    <family fieldname="fon" name="MS Shell Dlg 2"/>
    <size fieldname="hei" units="mu" value="10"/>
    <bold fieldname="" on="0"/>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_label20130306134458733',[% $id %])" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
