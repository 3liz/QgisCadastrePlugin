...
<qgis version="2.8.2-Wien" minimumScale="0" maximumScale="1800" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="geo_symblim">
  ...
  <renderer-v2 attr="geo_sym" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category render="true" symbol="1" value="39" label="mur mitoyen"/>
      <category render="true" symbol="2" value="40" label="mur non mitoyen"/>
      <category render="true" symbol="3" value="41" label="fossé mitoyen"/>
      <category render="true" symbol="4" value="42" label="fossé non mitoyen"/>
      <category render="true" symbol="5" value="43" label="clôture mitoyenne"/>
      <category render="true" symbol="6" value="44" label="clôture non mitoyenne"/>
      <category render="true" symbol="7" value="45" label="haie mitoyenne"/>
      <category render="true" symbol="8" value="46" label="haie non mitoyenne"/>
    </categories>
    <symbols>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_symblim20130224142527417',[% $id %])" icon="" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
