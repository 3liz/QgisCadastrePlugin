...
<qgis version="2.0.0-Dufour" minimumScale="0" maximumScale="100000" minLabelScale="1" maxLabelScale="100000" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_tronfluv20130224142527462',[% $id %])" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
