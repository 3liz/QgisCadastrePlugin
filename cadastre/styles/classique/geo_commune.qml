...
<qgis version="2.8.2-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="100000" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="0" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="tex2">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{b04c09b0-5e81-467c-b07c-07072996e477}">
      <rule scalemaxdenom="100000" label="&lt; 10 000" key="{52ab7951-a12f-4d87-9409-5f01b1d8e24f}" symbol="0" scalemindenom="1"/>
      <rule scalemaxdenom="1000000000" label="≥ 100 000" key="{79436f17-87a4-431f-98ae-e61836ea4f30}" symbol="1" scalemindenom="100000"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="188,78,14,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="tex2"/>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_commune20130224140230478',[% $id %])" icon="" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
