...
<qgis version="2.8.2-Wien" minimumScale="-4.65661e-10" maximumScale="250000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <labelattributes>
    ...
    <size fieldname="hei" units="mu" value="6"/>
    <bold fieldname="" on="0"/>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_label20130306141017635',[% $id %])" icon="" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
