...
<qgis version="2.8.2-Wien" minimumScale="0" maximumScale="1800" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="geo_tpoint">
  ...
  <renderer-v2 attr="geo_sym" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category render="true" symbol="1" value="12" label="calvaire"/>
      <category render="true" symbol="2" value="30" label="flèche de cours d'eau"/>
      <category render="true" symbol="3" value="47" label="halte"/>
      <category render="true" symbol="4" value="48" label="arrêt"/>
      <category render="true" symbol="5" value="49" label="station"/>
      <category render="true" symbol="6" value="50" label="pylône"/>
      <category render="true" symbol="7" value="63" label="puits"/>
      <category render="true" symbol="8" value="98" label="objet ponctuel divers"/>
    </categories>
    <symbols>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_tpoint20130224142527449',[% $id %])" icon="" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
