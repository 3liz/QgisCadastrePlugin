...
<qgis version="2.8.2-Wien" minimumScale="0" maximumScale="250100" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <labelattributes>
    ...
    <size fieldname="" units="pt" value="6"/>
    <bold fieldname="" on="0"/>
    ...
    <buffersize fieldname="" units="mu" value="0.4"/>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_label20130224134752223',[% $id %])" icon="" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
