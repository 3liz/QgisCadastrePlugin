...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="10500" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="0">
  <renderer-v2 attr="geo_dur" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="01" label="bâti dur"/>
      <category symbol="1" value="02" label="bâti léger"/>
    </categories>
    <symbols>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="geo_batiment"/>
    <edittype labelontop="0" editable="1" type="0" name="geo_commune"/>
    <edittype labelontop="0" editable="1" type="0" name="geo_dur"/>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_batiment20130205165130690',[% $id %])" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
