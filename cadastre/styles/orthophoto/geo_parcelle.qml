...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="20100" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="0">
  <renderer-v2 symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="0.745098" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="106,106,106,255"/>
          <prop k="color_border" v="255,229,153,255"/>
          <prop k="offset" v="0,0"/>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_parcelle20130205164935119',[% $id %])" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
