...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="10500" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyLocal="0">
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].audit('geo_subdfisc20130224135103620',[% $id %])" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
